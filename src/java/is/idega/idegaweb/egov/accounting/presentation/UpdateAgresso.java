...
public class UpdateAgresso extends IWBaseComponent {
	...
	protected void initializeComponent(FacesContext context) {
		...
		MethodBinding binding = WFUtil.createMethodBinding("#{AgressoBusinessBean.executeUpdate}",null);
		
		HtmlCommandButton button = new HtmlCommandButton();
		button.setId(this.getId()+"_agressoupdatebutton");
		button.setAction(binding);
		button.setValue("Keyra");
